...
class mit_b0(MixVisionTransformer):
    def __init__(self, pretrained = False):
        ...
        if pretrained:
            print("Load pretrained {}".format("src/segformer/mit_b0.pth"))
            self.load_state_dict(torch.load("src/segformer/mit_b0.pth"), strict = False)
...
class mit_b1(MixVisionTransformer):
    def __init__(self, pretrained = False):
        super(mit_b1, self).__init__(
            ...
            drop_rate = 0.0, drop_path_rate = 0.1)
        if pretrained:
            print("Load pretrained {}".format("src/segformer/mit_b1.pth"))
            weights = torch.load("src/segformer/mit_b1.pth")
...
class mit_b2(MixVisionTransformer):
    def __init__(self, pretrained = False):
        super(mit_b2, self).__init__(
            ...
            drop_rate = 0.0, drop_path_rate = 0.1)
        if pretrained:
            print("Load pretrained {}".format("src/segformer/mit_b2.pth"))
            weights = torch.load("src/segformer/mit_b2.pth")
            weights = {k:v for k,v in weights.items() if 'mlp' not in k}
            self.load_state_dict(weights, strict = False)
...
class mit_b3(MixVisionTransformer):
    def __init__(self, pretrained = False):
        super(mit_b3, self).__init__(
            ...
            drop_rate = 0.0, drop_path_rate = 0.1)
        if pretrained:
            print("Load pretrained {}".format("src/segformer/mit_b3.pth"))
            self.load_state_dict(torch.load("src/segformer/mit_b3.pth"), strict = False)
...
class mit_b4(MixVisionTransformer):
    def __init__(self, pretrained = False):
        super(mit_b4, self).__init__(
            ...
            drop_rate = 0.0, drop_path_rate = 0.1)
        if pretrained:
            print("Load pretrained {}".format("src/segformer/mit_b4.pth"))
            self.load_state_dict(torch.load("src/segformer/mit_b4.pth"), strict = False)
...
class mit_b5(MixVisionTransformer):
    def __init__(self, pretrained = False):
        super(mit_b5, self).__init__(
            ...
            drop_rate = 0.0, drop_path_rate = 0.1)
        if pretrained:
            print("Load pretrained {}".format("src/segformer/mit_b5.pth"))
            self.load_state_dict(torch.load("src/segformer/mit_b5.pth"), strict = False)
